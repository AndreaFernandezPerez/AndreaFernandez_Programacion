...
public class Alumno {
    ...
    //Constructor con 3 parámetros tipo int que inicialice los tres atributos
    //tnemeos que inicializar la variable asignatura, y crear una nueva variable Asignatura con el valor necesario
